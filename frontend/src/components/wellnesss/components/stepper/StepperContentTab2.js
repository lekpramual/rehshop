  ...
  useEffect(() => {
    if (iscount) {
      setData((data) => ({
        ...data,
        thermometer: {
          value: `${isdata[0].temperature}`,
        },
        pulse: { value: `${isdata[0].pulse}` },
        respire: { value: `${isdata[0].breath}` },
        blood: {
          value: `${isdata[0].blood_pressure}`,
        },
        weight: { value: `${isdata[0].weight}` },
        height: {
          value: `${isdata[0].height}`,
        },
        waistline: {
          value: `${isdata[0].waist}`,
        },
        illness: { value: "ไม่มี" },
        illness_txt: {
          value: "",
